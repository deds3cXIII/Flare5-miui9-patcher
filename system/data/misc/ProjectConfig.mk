...
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw ov8856_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw ov8856_mipi_raw
...
CUSTOM_MODEM = RLK6753_65T_C_M0_LWG_DSDS_S520_F1_G4_W18_L1L3L28
...
FACTORY_GPS_4STARS_ONEMORE38 = yes
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.39.1_rlk6753.65u.c.m0_P21
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
#CREATE_PROJECT_INFO=20160223142537

################################################################################
################################################################################

#####################################################
#               Xchengtech software verno Begin
#++++++++++++++++++++++++++++++++++++++++++++++++++++
RC_BUILD_VERNO = S520_DVT2_V1.0_F1_BOM_S20160725
CUSTOM_BUILD_VERNO = S520_DVT2_V1.0_F1_BOM_S20160725
#++++++++++++++++++++++++++++++++++++++++++++++++++++
#               Xchengtech software verno end.
#####################################################

#####################################################
#               ADUPS Configure Begin
#++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#####################################################
#               Google Configure Begin
#++++++++++++++++++++++++++++++++++++++++++++++++++++

#++++++++++++++++++++++++++++++++++++++++++++++++++++
#               Google Configure end.
#####################################################

#####################################################
#               Xchengtech Driver Configure Begin
#++++++++++++++++++++++++++++++++++++++++++++++++++++
RC_PROJECT = CONFIG_S520_PROJ
RC_SUB_PROJECT =
RC_SUB_SUB_PROJECT =
#++++++++++++++++++++++++++++++++++++++++++++++++++++
#               Xchengtech Driver Configure end.
#####################################################

#####################################################
#               Xchengtech MMI Configure Begin
#++++++++++++++++++++++++++++++++++++++++++++++++++++
RC_BUILD_VERNO = Cherry_Flare_5_V07_$(shell date +%m%d%Y)
CUSTOM_BUILD_VERNO = Cherry_Flare_5_V07_$(shell date +%m%d%Y)_GMS

RC_MTP_LABEL = Flare_5
RC_PTP_LABEL = Flare_5
RC_WIFI_TETHER_SSID = Flare_5
RC_WIFI_TETHER_PASSWORD = Flare_5
RC_WIFI_DIRECT_NAME = Flare_5
RC_BLUETOOTH_NAME = Flare_5
RC_INTERNAL_STORAGE_NAME = Flare_5
RC_PHOTO_MAKER_NAME = Cherry_Mobile
RC_PHOTO_MODEL_NAME = Flare_5

XC_PRODUCT_MANUFACTURER = Cherry_Mobile
XC_PRODUCT_BRAND = Cherry
XC_PRODUCT_MODEL = Flare_5
XC_DEFAULT_TIMEZONE = Asia/Manila

XC_DEFAULT_RINGTONE = Cherry_Caribbean.mp3
XC_DEFAULT_NOTIFICATION_TONE = Cherry_Tone1.mp3
#----------------- Int Config begin ----------------#
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++
#               Xchengtech MMI Configure end.
#####################################################
BUILD_GMS = yes
XC_GMS_VENDOR = default_6.0_r8
ADUPS_FOTA_SUPPORT = yes
ADUPS_FOTA_WITHOUT_MENU = no
ADUPS_FOTA_WITH_ICON = yes
FEATURE_KOZEN_AGING_TEST_SUPPORT = yes
XC_FEATURE_MIDTEST_KOZEN_SUPPORT = yes
FEATURE_WALLPAPER_CENTER_DEFAULT_SUPPORT = yes
GOOGLE_MTK_CALENDAR_OVERRIDES = true
XC_NUMBER_MIN_MATCH = 9
FEATURE_VIRTURAL_MENUKEY_LONGPRESS_SUPPORT = no
DATAPROTECTION_PERMISSION_SUPPORT = no
GOOGLE_PHOTO_NO_OVERRIDES = true
MTK_SOUNDRECORDER_APP = yes
NEW_CONTACTS_SHOW_ACCOUNT_SUPPORT = yes
GALLERY_PERMISSION_SUPPORT = no
GOOGLE_GMAIL_NO_OVERRIDES = true
GOOGLE_MUSIC_NO_OVERRIDES = true
FEATURE_LAUNCHER_ALLAPPLIST_TRANSPARENT = no
FEATURE_SEARCHBOX_IN_LAUNCHER_ALLAPPLIST = yes
DEFAULT_SETTING_AUDIO_VIBRATION = yes
DEFAULT_SETTING_AUDIO_SOUNDEFFECT = yes
FEATURE_CAMERA_RATIO_4_3 = yes
FEATURE_REMOVE_ASK_EVERYTIME_FOR_SMS = yes
FEATURE_CAMERA_FRONT_PICTURESIZE_SUPPORT = yes
FEATURE_SIDESLIP_KEY_SUPPORT = yes
FEATURE_DREAM_DOCKED_REMOVED_SUPPORT = yes
FEATURE_REJECT_BY_MESSAGE_WITH_DUAL_SIM = yes
PLATFORM_NAME_6753_SUPPORT = yes
FEATURE_FM_OPEN_SAVED_RECORDED_ANDROID_MUSIC = yes
FEATURE_CAMERA_HIDE_SMILE_ICON = yes
FEATURE_CAMERA_HIDE_SLOWMOTION_ICON = yes
FEATURE_CAMERA_MULTI_COLOR_SUPPORT = yes
EMAIL_PERMISSION_SUPPORT = no
MUSIC_PERMISSION_SUPPORT = no
FILEMANAGER_PERMISSION_SUPPORT = no
XC_FLASH_LIGHT_SHOW_TOAST_SUPPORT = yes

FEATURE_CAMERA_CUSTOM_CAMERA_PREVIEW_SIZE = yes
#####################################################
#               Customer Configure Begin
#++++++++++++++++++++++++++++++++++++++++++++++++++++
FEATURE_KOZEN_AGING_TEST_SUPPORT = yes
#++++++++++++++++++++++++++++++++++++++++++++++++++++
#               Customer Configure end.
#####################################################
